...
function print2(otherFn){
  ...
  function pow(num, x){
    ...
    let result = 1; // 곱했을때 결과에 영향을 주지 않기 위해 1 초기화
...
arrowList[2].addEventListener("click", ()=>{
    ...
    twoNuberPlus( (a,b)=>  a+b)


});

function twoNuberPlus( otherFn){
