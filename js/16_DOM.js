...
document.querySelector("#btn1").addEventListener("click", ()=>{
    ...
    const test = document.querySelector("#test"); // ul tag
...
// 1. 마지막 자식 노드로 취가( appendChild(노드) )
...
list[11].prepend("SEVENTEEN"); // 첫 번째 자식 (맨 앞) 추가


// 4. 이전/ 다음 형제로 추가( befor/after()"내용" 또는 노드 또는 요소 *n )
