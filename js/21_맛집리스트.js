...
resList.push(new Restaurant("왕가탕후루", "사인머스캑, 딸기, 통귤", "서울시 서대문구"));
...
/* 조회 버튼 클릭시 #printList의 이전 내용을 모두 삭제하고 
...
selectBtn.addEventListener("click", ()=>{
  ...
  for(let i=0; i<resList.length ; i++){
    ...
    /* 만들어진 li에 내용으로
    resList[i]의 informatio() 메서드 반환 값 대입 */
    li.innerText = resList[i].information();

    // li요소를 #printList의 마지막 자식으로 추가
